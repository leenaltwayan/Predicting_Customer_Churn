...
Version: 0.1
Date: 12/12/2021
This module provides a set of functions that will predict customer churn, including:
- Data Import
- Data Preparation
- Visualization
- Model Training
...
def train_models(X_train, X_test, y_train, y_test):
    ...
    try:
        ...
        print(
            'in train_models: Incorrect parameters; make sure X values are dataframes \
        and Y values are a list')
        print(msg)
