...
def test_encoder_helper(encoder_helper):
    ...
    try:
        ...
        logging.error(
            "Testing encoder_helper: The new Dataframe doesn't appear to have rows and columns")
        raise err
...
if __name__ == "__main__":
    ...
    # unsure how to test this since the parameters are the functions
    # themselves and not the parameters for the function (by following example
    # of first testing funtion)
